...
Defines repository-native conventions for markdown-first blueprint contract packages and evaluation-ready artifact generation.
...
AIBM-Lite blueprints function as **soft operational contracts**. Hard contracts exist but are enforced informally by human reviewers.
...
AIBM-Operational blueprints are **hard operational contracts**. Hard contracts are machine-validated. Soft contracts are scored. Outputs are gated on evaluation results.
