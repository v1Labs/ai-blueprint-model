...
This document defines semantic versioning conventions for ABM blueprints.
...
ABM blueprints use [Semantic Versioning](https://semver.org/) in the form `MAJOR.MINOR.PATCH`.
